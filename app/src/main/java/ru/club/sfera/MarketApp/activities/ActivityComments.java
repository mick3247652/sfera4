...
import ru.club.sfera.MarketApp.adapter.AdapterComments;
import ru.club.sfera.MarketApp.callbacks.CallbackComments;
import ru.club.sfera.MarketApp.models.Comments;
...
public class ActivityComments extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.market_activity_comments);
        ...
        swipeRefreshLayout.setColorSchemeResources(R.color.market_colorOrange, R.color.market_colorGreen, R.color.market_colorBlue, R.color.market_colorRed);
        ...
        adapterCategory.setOnItemClickListener(new AdapterComments.OnItemClickListener() {
            ...
            public void onItemClick(View v, final Comments obj, int position, final Context context) {
                ...
                if (app.getIsLogin() && app.getUserId().equals(obj.user_id)) {

                    LayoutInflater layoutInflaterAndroid = LayoutInflater.from(context);
                    View mView = layoutInflaterAndroid.inflate(R.layout.market_custom_dialog_edit, null);
                    ...
                    btn_delete.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            builder.setMessage(getString(R.string.market_confirm_delete_comment));
                            ...
                            builder.setNegativeButton(getString(R.string.market_dialog_no), null);
                    ...
                    LayoutInflater layoutInflaterAndroid = LayoutInflater.from(context);
                    View mView = layoutInflaterAndroid.inflate(R.layout.market_custom_dialog_reply, null);
                    ...
                    btn_reply.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            intent.putExtra("user_id", app.getUserId());
        ...
        btn_add_comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (app.getIsLogin()) {
                    //Toast.makeText(getApplicationContext(), "id : " + App.getUserId() + nid, Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(getApplicationContext(), getResources().getString(R.string.market_login_required), Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void setupToolbar() {
        ...
        if (actionBar != null) {
            ...
            getSupportActionBar().setTitle(getResources().getString(R.string.market_title_comments));
        }
    }
    ...
    private void showNoItemView(boolean show) {
        ...
        ((TextView) findViewById(R.id.txt_no_comment)).setText(R.string.market_msg_no_comment);
        if (show) {
            recyclerView.setVisibility(View.GONE);
