...
public class ActivityUserRegister extends AppCompatActivity implements Validator.ValidationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.market_activity_user_register);
    ...
    public void onValidationSucceeded() {
        ...
        if (NetworkCheck.isNetworkAvailable(ActivityUserRegister.this)) {
            ...
            dialog.setMessage(R.string.market_msg_no_network);
    ...
    private class MyTaskRegister extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog.setMessage(getResources().getString(R.string.market_register_process));
    ...
    public void setResult() {
        ...
        if (Constant.GET_SUCCESS_MSG == 0) {
            ...
            dialog.setTitle(R.string.market_whops);
            dialog.setMessage(R.string.market_register_exist);
            dialog.setPositiveButton(R.string.market_dialog_ok, null);
            dialog.setCancelable(false);
            dialog.show();
            ...
            AlertDialog.Builder dialog = new AlertDialog.Builder(ActivityUserRegister.this);
            dialog.setTitle(R.string.market_register_title);
            dialog.setMessage(R.string.market_register_success);
