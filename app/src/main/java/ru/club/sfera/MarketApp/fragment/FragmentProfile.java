...
import ru.club.sfera.MarketApp.activities.ActivityPrivacyPolicy;
import ru.club.sfera.MarketApp.activities.ActivityProfile;
import ru.club.sfera.MarketApp.activities.ActivityUserLogin;
import ru.club.sfera.MarketApp.activities.ActivityUserRegister;
import ru.club.sfera.MarketApp.adapter.AdapterAbout;
import ru.club.sfera.MarketApp.utils.ApiConnector;
...
public class FragmentProfile extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        root_view = inflater.inflate(R.layout.market_fragment_profile, null);
        ...
        progressDialog.setMessage(getResources().getString(R.string.market_logout_process));
        ...
        adapterAbout.setOnItemClickListener(new AdapterAbout.OnItemClickListener() {
            ...
            public void onItemClick(View v, Data obj, int position) {
                ...
                if (position == 1) {
                    ...
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(getString(R.string.market_play_more_apps))));
                } else if (position == 3) {
                    aboutDialog();
                }
            }
    ...
    public void logoutDialog() {
        ...
        builder.setTitle(R.string.market_logout_title);
        builder.setMessage(R.string.market_logout_message);
        builder.setPositiveButton(R.string.market_dialog_yes, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface di, int i) {

                app.getInstance().saveIsLogin(false);
                progressDialog.show();
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
                        builder.setMessage(R.string.market_logout_success);
                        builder.setPositiveButton(R.string.market_dialog_ok, new DialogInterface.OnClickListener() {
                            @Override
        ...
        builder.setNegativeButton(R.string.market_dialog_cancel, null);
        builder.show();
    ...
    private class getUserImage extends AsyncTask<ApiConnector, Long, JSONArray> {
        ...
        protected JSONArray doInBackground(ApiConnector... params) {
            return params[0].GetCustomerDetails(app.getUserId());
        }
        ...
        protected void onPostExecute(JSONArray jsonArray) {
            ...
            try {
                ...
                if (user_image.equals("")) {
                    img_profile.setImageResource(R.drawable.market_ic_user_account);
                } else {
    ...
    private List<Data> getDataInformation() {
        ...
        data.add(new Data(
                R.drawable.market_ic_drawer_privacy,
                getResources().getString(R.string.market_title_about_privacy),
                getResources().getString(R.string.market_sub_title_about_privacy)
        ));

        data.add(new Data(
                R.drawable.market_ic_drawer_rate,
                getResources().getString(R.string.market_title_about_rate),
                getResources().getString(R.string.market_sub_title_about_rate)
        ));

        data.add(new Data(
                R.drawable.market_ic_drawer_more,
                getResources().getString(R.string.market_title_about_more),
                getResources().getString(R.string.market_sub_title_about_more)
        ));

        data.add(new Data(
                R.drawable.market_ic_drawer_info,
                getResources().getString(R.string.market_title_about_info),
                ""
        ));
    ...
    public void aboutDialog() {
        ...
        View mView = layoutInflaterAndroid.inflate(R.layout.market_custom_dialog_about, null);

        final AlertDialog.Builder alert = new AlertDialog.Builder(getActivity());
        alert.setView(mView);
        alert.setCancelable(false);
        alert.setPositiveButton(R.string.market_dialog_ok, new DialogInterface.OnClickListener() {
            @Override
