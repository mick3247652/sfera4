...
public class GDPR {
    ...
    public static void updateConsentStatus(final Activity act) {
        ...
        consentInformation.requestConsentInfoUpdate(new String[]{act.getString(R.string.market_admob_publisher_id)}, new ConsentInfoUpdateListener() {
            @Override
    ...
    private static class GDPRForm {
        ...
        private URL getUrlPrivacyPolicy(Activity act) {
            URL mUrl = null;
            try {
                mUrl = new URL(act.getString(R.string.market_privacy_policy_url));
