...
public class AdapterComments extends RecyclerView.Adapter<AdapterComments.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.market_lsv_item_comments, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        if (app.getIsLogin() && app.getUserId().equals(c.user_id)) {
            holder.user_name.setText(c.name + " ( " + ctx.getResources().getString(R.string.market_txt_you) + " )");
        } else {
