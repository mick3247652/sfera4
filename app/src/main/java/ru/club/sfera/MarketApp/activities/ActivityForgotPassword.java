...
public class ActivityForgotPassword extends AppCompatActivity implements Validator.ValidationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.market_activity_user_forgot);
    ...
    public void onValidationSucceeded() {
        ...
        if (NetworkCheck.isNetworkAvailable(ActivityForgotPassword.this)) {
            ...
            Toast.makeText(getApplicationContext(), getResources().getString(R.string.market_msg_no_network), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void setResult() {
        ...
        if (Constant.GET_SUCCESS_MSG == 0) {
            ...
            dialog.setMessage(R.string.market_forgot_failed_message);
            ...
            AlertDialog.Builder dialog = new AlertDialog.Builder(this);
            dialog.setTitle(R.string.market_dialog_success);
            dialog.setMessage(R.string.market_forgot_success_message);
