...
public class ActivityProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.market_activity_profile);
        ...
        if (actionBar != null) {
            ...
            getSupportActionBar().setTitle(R.string.market_title_menu_profile);
        }
    ...
    private void showSettingsDialog() {
        ...
        builder.setMessage(R.string.market_permission_upload);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.market_menu_profile, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            ...
            case R.id.save:
                if (NetworkCheck.isNetworkAvailable(ActivityProfile.this)) {
                    new MyTaskUp().execute(Constant.PROFILE_UPDATE_URL + app.getUserId() +
    ...
    public void setResult() {
        ...
        if (Constant.GET_SUCCESS_MSG == 0) {
            ...
            progressDialog = new ProgressDialog(ActivityProfile.this);
            progressDialog.setTitle(R.string.market_updating_profile);
            progressDialog.setMessage(getResources().getString(R.string.market_waiting_message));
            progressDialog.setCancelable(false);
            progressDialog.show();
            ...
            try {
                ...
                if (user_image.equals("")) {
                    ...
                    Picasso.with(ActivityProfile.this)
                            ...
                            .resize(300, 300)
                            .centerCrop()
                            .placeholder(R.drawable.market_ic_user_account)
                            .into(img_profile);
                }
