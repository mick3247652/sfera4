...
public class Profile extends Application implements Constants, Parcelable {
    ...
    private int mood, state, sex, year, month, day, verify, pro, itemsCount, photosCount, videosCount, likesCount, giftsCount, friendsCount, followingsCount, followersCount, allowComments, allowMessages, lastAuthorize, accountType;
