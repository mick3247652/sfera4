...
public interface Constants {
    ...
    public static final String BILLING_KEY = "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMI";

    public static final String WEB_SITE = "http://sfera.press/";  //web site url address
    ...
    public static final String API_DOMAIN = "http://api.sfera.press/";  //url address to which the application sends requests
