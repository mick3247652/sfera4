...
//                showPostDialog();
    ...
    private void updateProfileInfo() {
        ...
        if (isAdded()) {
            ...
            SpannableStringBuilder txt = new SpannableStringBuilder(String.format(Locale.getDefault(), getString(R.string.msg_new_item_promo), App.getInstance().getFullname()));
