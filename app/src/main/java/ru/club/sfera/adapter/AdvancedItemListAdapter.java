...
import ru.club.sfera.MediaViewerActivity;
                ...
                switch (actionId){
                    ...
                    case R.id.action_remove: {
                        ...
                        alertDialog.setPositiveButton(context.getText(R.string.action_yes), new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                api.commentDelete(itemsList.get(position).getId());
                    ...
                    case R.id.action_reply: {
                        ...
                        if (App.getInstance().getId() != 0) {
                            ...
                            mCommentEditor.setText("@" + obj.getFromUserUsername() + ", ");
        ...
        mSendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (text.length() != 0) {
                    ...
                    Api api = new Api(context);
                    api.sendComment(item.getId(), replyToUserId, text, itemsList, itemsAdapter);
